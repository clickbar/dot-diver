...
it("Nested Path of nested objects in index signature gets returned correctly", () => {
    ...
    type ExpectedType = string | number | `${string}.${string}` | `${string}.${string}.a` | `${string}.${string}.b`
...
it('PathValue works with readonly (nested) members', () => {
    ...
    assertType<{ readonly stringProp: string }>(null as unknown as PathValue<TestTypeObject, 'object'>)
